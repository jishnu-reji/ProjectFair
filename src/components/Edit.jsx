        ...
        <Modal.Body>
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <div className='mb-2'>
                <input type="text" value={projectData.language} onChange={(e)=>setProjectData({...projectData,language:e.target.value})} className="form-control" placeholder='Languages used in the Project'/>
              </div>
              <div className='mb-2'>
